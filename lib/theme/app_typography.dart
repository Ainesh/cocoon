...
abstract final class AppTypography {
  ...
  static String get taglineFontFamily => GoogleFonts.cormorantGaramond().fontFamily!;
  ...
  static TextStyle taglineLarge({Color? color}) => GoogleFonts.cormorantGaramond(
        fontSize: 24,
        fontWeight: FontWeight.w600,
        fontStyle: FontStyle.italic,
        color: color ?? AppColors.lightText,
  ...
  static TextStyle healthRemark({Color? color}) => GoogleFonts.cormorantGaramond(
        fontSize: 36,
        fontWeight: FontWeight.w700,
        fontStyle: FontStyle.italic,
  ...
  static TextStyle appBarTitle({Color? color, FontWeight? weight}) => GoogleFonts.outfit(
        fontSize: 22,
  ...
  static TextStyle navLabel({Color? color, FontWeight? weight}) => GoogleFonts.inter(
        fontSize: 12,
        fontWeight: weight ?? FontWeight.w500,
        color: color ?? AppColors.dimText,
      );
