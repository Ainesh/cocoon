/// Event and Moment display cards for the dashboard.
library;
...
class _MomentPreview extends StatelessWidget {
  ...
  String _getDateLabel() {
    final label = moment.relativeDate;
    
    // Add time slot for connect moments
    if (moment.type == MomentType.connect && moment.timeSlot != null) {
      return '$label, ${moment.timeSlot!.label.toLowerCase()}';
    }
    
    // Add duration for escape moments
    if (moment.type == MomentType.escape && moment.endDate != null) {
      return '$label (${moment.nights} nights)';
    }
...
// =============================================================================
// Legacy Event Cards (for backwards compatibility)
// =============================================================================
