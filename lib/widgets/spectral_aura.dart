        ...
        child: AnimatedBuilder(
          ...
          builder: (context, _) => CustomPaint(
            painter: _AuraPainter(
              ...
              breathPhase: CurveTween(curve: Curves.easeInOutSine)
...
class _AuraPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(
      ...
      maxR * 0.9,
      Paint()
        ..shader = ui.Gradient.radial(center, maxR * 0.9, [
    ...
    for (int r = 0; r < _ringCount; r++) {
      ...
      final ringColor =
          Color.lerp(c1, c2, (r / (_ringCount - 1)).clamp(0.0, 1.0))!;
    ...
    canvas.drawCircle(center, coreR * 4, Paint()
      ..shader = ui.Gradient.radial(center, coreR * 4, [
    ...
    canvas.translate(-center.dx, -center.dy);
    canvas.drawCircle(center, maxR * 0.55, Paint()
