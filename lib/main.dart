...
class CocoonApp extends StatelessWidget {
  ...
  ThemeData _buildCocoonTheme() {
    ...
    final taglineStyle = GoogleFonts.cormorantGaramond(color: AppColors.subtleText);
    ...
    final textTheme = TextTheme(
      ...
      headlineLarge: headlineStyle.copyWith(fontSize: 32, fontWeight: FontWeight.w600, color: AppColors.lightText),
      headlineMedium: headlineStyle.copyWith(fontSize: 24, fontWeight: FontWeight.w500, color: AppColors.subtleText),
      headlineSmall: headlineStyle.copyWith(fontSize: 20, fontWeight: FontWeight.w500, color: AppColors.lightText),
      // Titles (Inter)
      titleLarge: bodyStyle.copyWith(fontSize: 20, fontWeight: FontWeight.w600, color: AppColors.lightText),
      titleMedium: bodyStyle.copyWith(fontSize: 16, fontWeight: FontWeight.w600, color: AppColors.lightText),
      titleSmall: bodyStyle.copyWith(fontSize: 14, fontWeight: FontWeight.w600, color: AppColors.subtleText),
      ...
      bodySmall: bodyStyle.copyWith(fontSize: 12, fontWeight: FontWeight.w400, color: AppColors.dimText),
      // Labels
      labelLarge: bodyStyle.copyWith(fontSize: 14, fontWeight: FontWeight.w600, color: AppColors.lightText),
      labelMedium: bodyStyle.copyWith(fontSize: 12, fontWeight: FontWeight.w500, color: AppColors.subtleText),
      labelSmall: taglineStyle.copyWith(fontSize: 14, fontWeight: FontWeight.w400, fontStyle: FontStyle.italic, color: AppColors.subtleText),
    );
    ...
    return ThemeData(
      ...
      appBarTheme: AppBarTheme(
        ...
        titleTextStyle: headlineStyle.copyWith(fontSize: 20, fontWeight: FontWeight.w500, color: AppColors.lightText),
      ),
      ...
      navigationBarTheme: NavigationBarThemeData(
        ...
        labelTextStyle: WidgetStateProperty.resolveWith((states) {
          if (states.contains(WidgetState.selected)) {
            return bodyStyle.copyWith(fontSize: 12, fontWeight: FontWeight.w600, color: AppColors.refinedRed);
          }
          return bodyStyle.copyWith(fontSize: 12, fontWeight: FontWeight.w500, color: AppColors.dimText);
        }),
      ),
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        labelStyle: bodyStyle.copyWith(color: AppColors.dimText, fontWeight: FontWeight.w500),
        hintStyle: bodyStyle.copyWith(color: AppColors.dimText.withValues(alpha: 0.6)),
      ...
      outlinedButtonTheme: OutlinedButtonThemeData(
        style: _buttonStyle().copyWith(
          ...
          side: WidgetStatePropertyAll(BorderSide(color: AppColors.refinedRed.withValues(alpha: 0.5), width: 1.5)),
        ),
      ),
      ...
      floatingActionButtonTheme: FloatingActionButtonThemeData(
        ...
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
        extendedTextStyle: bodyStyle.copyWith(fontSize: 14, fontWeight: FontWeight.w600, color: AppColors.pureBlack),
      ),
      ...
      segmentedButtonTheme: SegmentedButtonThemeData(
        style: ButtonStyle(
          backgroundColor: WidgetStateProperty.resolveWith((states) {
            if (states.contains(WidgetState.selected)) return AppColors.refinedRed.withValues(alpha: 0.15);
            return AppColors.darkGlass;
          }),
          foregroundColor: WidgetStateProperty.resolveWith((states) {
            if (states.contains(WidgetState.selected)) return AppColors.refinedRed;
            return AppColors.subtleText;
          }),
          side: WidgetStatePropertyAll(BorderSide(color: AppColors.refinedRed.withValues(alpha: 0.2))),
      ...
      snackBarTheme: SnackBarThemeData(
        ...
        contentTextStyle: bodyStyle.copyWith(fontSize: 14, color: AppColors.lightText),
      ...
      dialogTheme: DialogThemeData(
        ...
        titleTextStyle: headlineStyle.copyWith(fontSize: 22, fontWeight: FontWeight.w500, color: AppColors.lightText),
        contentTextStyle: bodyStyle.copyWith(fontSize: 16, color: AppColors.subtleText),
      ),
      ...
      // Dividers
      dividerTheme: DividerThemeData(color: AppColors.refinedRed.withValues(alpha: 0.1), thickness: 1),
      ...
      chipTheme: ChipThemeData(
        ...
        side: BorderSide(color: AppColors.refinedRed.withValues(alpha: 0.2)),
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
        labelStyle: bodyStyle.copyWith(fontSize: 14, color: AppColors.lightText),
        elevation: 0,
      ),
      ...
      listTileTheme: ListTileThemeData(
        ...
        titleTextStyle: bodyStyle.copyWith(fontSize: 16, fontWeight: FontWeight.w500, color: AppColors.lightText),
        subtitleTextStyle: bodyStyle.copyWith(fontSize: 14, color: AppColors.subtleText),
      ...
      switchTheme: SwitchThemeData(
        ...
        trackColor: WidgetStateProperty.resolveWith((states) {
          if (states.contains(WidgetState.selected)) return AppColors.refinedRed.withValues(alpha: 0.3);
      ...
      checkboxTheme: CheckboxThemeData(
        ...
        side: BorderSide(color: AppColors.refinedRed.withValues(alpha: 0.5), width: 2),
  ...
  ButtonStyle _buttonStyle() {
    return ButtonStyle(
      ...
      shadowColor: WidgetStatePropertyAll(AppColors.refinedRed.withValues(alpha: 0.25)),
